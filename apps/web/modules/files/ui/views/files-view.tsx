                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                              ...
                              <TableHead className="px-6 font-medium">Type</TableHead>
                              <TableHead className="px-6 font-medium">Size</TableHead>
                              <TableHead className="px-6 font-medium">Actions</TableHead>  
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {(()=>{
