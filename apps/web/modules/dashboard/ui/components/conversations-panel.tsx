    ...
    return(
        <div className="flex h-full w-full flex-col">
            <div className="flex flex-col gap-3.5 border-b p-2">
                <Select defaultValue="all" onValueChange={(value)=>setStatusFilter(value as "unresolved" | "resolved" | "all" | "escalated")} value={statusFilter}>
                ...
                <div className="flex w-full flex-1 flex-col text-sm">
                    {conversations.results.map((conversation)=>{
                        ...
                        return (
                            ...
                            >
                                <div className={cn("translate-y-1/2 absolute top-1/2 left-0 h-[64%] w-1 rounede-full bg-neutral-300 opacity-0 transition-opacity", pathname === `/conversations/${conversation._id}` && "opacity-100")}/>
                                <DiceBearAvatar
...
export const SkeletonConverstions = ()=>{
    return(
