            ...
            <AIConversation className="max-h-[calc(100vh-180px)]">
               <AIConversationContent>
                    {Array.from({length: 8}, (_, index)=>{
                        ...
                        return (
                            <div
                                className={cn(`group flex w-full items-end justify-end gap-2 py-2 [&>div]:max-w-[80%]`, isUser ? "is-user": "is-assistant flex-row-reverse")}
                                key={index}
                            >
                                <Skeleton className={`h-9 ${width} rounede-lg bg-neutral-200`}/>
                                <Skeleton className="size-8 rounede-full bg-neutral-200"/>
                            </div>
                        )
                    })}
                </AIConversationContent> 
